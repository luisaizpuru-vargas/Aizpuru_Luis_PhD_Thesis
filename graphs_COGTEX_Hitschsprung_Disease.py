...
ax[0].set_title('1st Order Unique Counts vs. Threshold for Hirschsprung Disease', fontsize = 16)
...
queried_genes =  set(["RET", "EDNRB", "GDNF", "EDN3"])  # Example queried genes query = ["MKL2", "MYH7", "NKX2-5"]
use_absolute = True  # Set to True to use absolute correlation values
...
y_01 = [4, 5606 , 23254, 2358 ]
y_01_cum = [4, 5610, 28864 , 31222 ]

###  r = abs(0.2)

### Unique
y_02 = [4, 767 , 17271, 6406 ]
y_02_cum = [4, 771, 18042 , 24448 ]


###  r = abs(0.30)

y_03 = [4, 88, 3704, 11904 ]
y_03_cum = [4, 92,3796 , 15700 ]

###  r = abs(0.40)

y_04 = [4, 9, 255, 1880 ]
y_04_cum = [4, 13, 268, 2148 ]
...
# Customize the plot
plt.title('Unique Peripherals for Hirschsprung Disease', fontsize = 12)
