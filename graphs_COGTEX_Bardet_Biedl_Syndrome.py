...
query = ["BBS1", "BBS2", "BBS4", "BBS5", "BBS7", "BBS10", "BBS12"]
...
ax[0].set_title('1st Order Unique Counts vs. Threshold for Bardet-Biedl Syndrome', fontsize = 16)
...
# Parameters
threshold = 0.6  # Correlation threshold (adjust as needed)
queried_genes =  set(["BBS1", "BBS2", "BBS4", "BBS5", "BBS7", "BBS10", "BBS12"])  # Example queried genes query = ["MKL2", "MYH7", "NKX2-5"]
use_absolute = True  # Set to True to use absolute correlation values
...
y_01 = [7, 15604, 14667, 1194 ]
y_01_cum = [7, 15611 , 30278 , 31472 ]

###  r = abs(0.2)

### Unique
y_02 = [7, 5189 , 16625 , 3173]
y_02_cum = [7, 5196, 21821 , 24994]


###  r = abs(0.30)

y_03 = [7, 934, 11525, 5018]
y_03_cum = [7, 941, 12466, 17484]

###  r = abs(0.40)

y_04 = [7, 98, 2454, 6067 ]
y_04_cum = [7, 105,2559 ,8626 ]

###  r = abs(0.50)

y_05 = [7, 3, 75, 694 ]
y_05_cum = [7, 10 , 85, 778 ]
...
# Customize the plot
plt.title('Unique Peripherals for Bardet Beidl Syndrome', fontsize = 12)
